...
import me.limeglass.epicmines.manager.managers.ActionbarManager;
...
public class MessageBuilder {
	...
	private String applyPlaceholders(String input) {
		...
		int i = EpicMines.getInstance().getConfig().getInt("general.new-lines", 4); //The max about of new lines users are allowed.
	...
	public void sendActionbar() {
		...
		ActionbarManager actionbar = EpicMines.getInstance().getManager(ActionbarManager.class);
		if (senders != null && senders.size() > 0) {
