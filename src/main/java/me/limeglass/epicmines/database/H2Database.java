...
public class H2Database<T> extends Database<T> {
	...
	public H2Database(String tablename, Type type, MineFlag... flags) throws SQLException, ClassNotFoundException {
		super(flags);
		this.tablename = tablename;
		this.type = type;
		Class.forName("org.h2.Driver");
		String url = "jdbc:h2:" + EpicMines.getInstance().getDataFolder().getAbsolutePath() + File.separator + "database";
